    ...
    def __init__(
        ...
        *,
        ...
        self.q_proj = nnx.Linear(
            d_model, k_proj_dim, use_bias=False, kernel_init=_XAVIER,
        ...
        self.v_proj = nnx.Linear(
            d_model, v_proj_dim, use_bias=False, kernel_init=_XAVIER,
            dtype=compute_dtype, param_dtype=F32, rngs=rngs
        )
        self.b_proj = nnx.Linear(
            d_model, k_proj_dim, use_bias=True, kernel_init=_XAVIER,
            dtype=compute_dtype, param_dtype=F32, rngs=rngs
        )  # Proj_b, Eq. 85: b = σ(Proj_b x)
        self.w_proj = nnx.Linear(
            d_model, v_proj_dim, use_bias=True, kernel_init=_XAVIER,
            dtype=compute_dtype, param_dtype=F32, rngs=rngs
        ...
        self.o_proj = nnx.Linear(
            v_proj_dim, d_model, use_bias=False, kernel_init=_XAVIER,
            dtype=compute_dtype, param_dtype=F32, rngs=rngs
        )  # back to d_model
